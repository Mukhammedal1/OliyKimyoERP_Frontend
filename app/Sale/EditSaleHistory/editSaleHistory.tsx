...
const EditSaleHistoryPage = () => {
  ...
  useEffect(() => {
    if (!productIdNameUnit || products.length === 0) return;

    const foundProduct = products.find(
      (p: any) => p._id === productIdNameUnit.split("|")[0],
    );

    if (foundProduct) {
      setStockAmount(foundProduct.stock_amount);
    }
  }, [productIdNameUnit, products]);
              ...
              (isProductLoading ? (
                ...
                <AddProductWrapper>
                  ...
                  <ContentWrapper2>
                    <SelectWrapper2>
                      ...
                      <Select
                        ...
                        onChange={(selectedOption: any) => {
                          ...
                          setStockAmount(selectedOption?.stock_amount || null);
                        }}
                        isSearchable={true}
                        menuPortalTarget={document.body}
                        styles={{
                    ...
                    <InputWrapper2>
                      <p>Ombordagi soni ({productIdNameUnit.split("|")[2]})</p>
                      <Input2>
                        <input
                          type="number"
                          value={stock_amount}
